...
#define nrn_init _nrn_init__ExpSyn3
#define _nrn_initial _nrn_initial__ExpSyn3
#define nrn_cur _nrn_cur__ExpSyn3
#define _nrn_current _nrn_current__ExpSyn3
#define nrn_jacob _nrn_jacob__ExpSyn3
#define nrn_state _nrn_state__ExpSyn3
#define _net_receive _net_receive__ExpSyn3 
#define state state__ExpSyn3 
...
#define _f_mgblock _f_mgblock_ExpSyn3
#define mgblock mgblock_ExpSyn3
...
#define mg mg_ExpSyn3
 double mg = 1;
#define usetable usetable_ExpSyn3
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "tau", 1e-09, 1e+09,
 "usetable_ExpSyn3", 0, 1,
 0,0,0
};
 ...
 "mg_ExpSyn3", &mg_ExpSyn3,
 "usetable_ExpSyn3", &usetable_ExpSyn3,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 ExpSyn3 /Users/mariumyousuf/Desktop/causal/fall2025/NEURONFA25/CoreSmallNet/modfiles/expsyn3.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   i = gmax * g * mgblock ( _threadargscomma_ v ) * ( v - e ) ;
   }
 _current += i;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mariumyousuf/Desktop/causal/fall2025/NEURONFA25/CoreSmallNet/modfiles/expsyn3.mod";
static const char* nmodl_file_text = 
  "\n"
