...
#define caini _p[3]
#define caini_columnindex 3
#define kt _p[4]
#define kt_columnindex 4
#define kd _p[5]
#define kd_columnindex 5
#define decay _p[6]
#define decay_columnindex 6
#define cai _p[7]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cad /Users/mariumyousuf/Desktop/causal/fall2025/NEURONFA25/CoreSmallNet/modfiles/cad.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset = 0; {
   ...
   drive_pump = - kt * ( cai - cainf ) / ( cai - cainf + kd ) ;
   Dcai = decay * ( drive_channel + drive_pump + ( cainf - cai ) / taur ) ;
   }
 return _reset;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mariumyousuf/Desktop/causal/fall2025/NEURONFA25/CoreSmallNet/modfiles/cad.mod";
static const char* nmodl_file_text = 
  ...
  "	RANGE depth,kt,kd,cainf,taur,decay,caini\n"
  "}\n"
  "\n"
  "UNITS {\n"
  ...
  "        drive_pump = -kt * (cai-cainf)/ (cai -cainf+ kd ): Michaelis-Menten - JM, modified\n"
  "                                                         : for a resting at cainf\n"
  "\n"
  "\n"
  ":	cai' = drive_channel + drive_pump + (cainf-cai)/taur\n"
  "        cai' = decay*(drive_channel + drive_pump + (cainf-cai)/taur) : JM -modified to allow for\n"
  "                                                                    : the tuning of Ca decay\n"
  "}\n"
  "\n"
  ;
#endif
