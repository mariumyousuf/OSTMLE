...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Na /Users/mariumyousuf/Desktop/causal/fall2025/NEURONFA25/CoreSmallNet/modfiles/na.mod\n");
...
static int  rates ( _threadargsproto_ ) {
    minf = 1.0 / ( 1.0 + exp ( - ( v + 30.0 ) / 9.5 ) ) ;
   hinf = 1.0 / ( 1.0 + exp ( ( v + 53.0 ) / 7.0 ) ) ;
   htau = 0.37 + 2.78 / ( 1.0 + exp ( ( v + 40.5 ) / 6.0 ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mariumyousuf/Desktop/causal/fall2025/NEURONFA25/CoreSmallNet/modfiles/na.mod";
static const char* nmodl_file_text = 
