...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kdr /Users/mariumyousuf/Desktop/causal/fall2025/NEURONFA25/CoreSmallNet/modfiles/kdr.mod\n");
...
static int  rates ( _threadargsproto_ ) {
    ninf = 1.0 / ( 1.0 + exp ( - ( v + 30.0 ) / 10.0 ) ) ;
   ntau = 0.37 + 1.85 / ( 1.0 + exp ( ( v + 27.0 ) / 15.0 ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mariumyousuf/Desktop/causal/fall2025/NEURONFA25/CoreSmallNet/modfiles/kdr.mod";
static const char* nmodl_file_text = 
